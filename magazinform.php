...
<html lang="en">
	...
	<body>
		<h1>Add a New Magazin-</h1>
		<hr color="#BD4D3D" height="2px" />
		<div id="mbrform" >
			<form action="home.php?p=magazins.php" method="post" autpfill="off" >
				<label id="name_lbl" >Magazin Name</label>	<input type="text" name="name" size="50" required/><br />
				<br />
